...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,800;0,900;1,200;1,400;1,600;1,700;1,900&display=swap" rel="stylesheet">
    <!-- Scripts -->
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                CONFERENCE OF THE DIRECTORS GENERAL OF CIVIL AVIATION Asia and Pacific Region PHILIPPINES
                </a>
