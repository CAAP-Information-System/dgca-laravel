...
<div class="container">
    <section class="section-grp">
        ...
        <div class="section-content">
            ...
            <div class="section-subheader-content">
                <p>These are intended to inform the Conference about <b class="text-primary">trends and developments</b> occurring within States/Administrations, or they deal with innovative policy issues and technological advancements of interest to States/Administrations. Some Information Papers explain progress in promoting ICAO policies and/or provisions.</p>
            </div>
            ...
            <div class="section-content">
                <div class="section-subheader-content">
                    <ol>
                        ...
                        <li>Data processing format: MS Word (.doc, .docx)</li>
                    </ol>
                </div>
            </div>
        </div>
